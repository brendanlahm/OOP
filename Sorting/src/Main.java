...
public class Main {
    public static void main(String[] args) {
        ...
        ArrayList<Hotel> selectedList = selectionSort.select(catalog);

        // Print sorted Hotel Catalog
//        System.out.println("\nNew sorted Hotel Catalog:");
//        for (Hotel i : selectedList) {
//            System.out.println(i);
//        }
        ...
        ArrayList<Hotel> bubbledList = bubbleSortList.bubbleList(catalog);
